...
struct SettingsWorkspaceDestinationView: View {
    ...
    var body: some View {
        ...
        case .appDevices: AppDeviceListSettingsView()
        case .appConnection: AppConnectionSettingsView()
        case .activityCenter: AppNotificationSettingsView()
        case .liveActivities: AppLiveActivitiesView()
        case .diagnostics: AppDiagnosticsSettingsView()
        case .advanced: AppAdvancedSettingsView()
